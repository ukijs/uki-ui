...
var defaultStyle = ".OverlaidView .overlayShadowEl {\n  position: absolute;\n  /* left, right, top, bottom set by JS */\n}\n.OverlaidView .overlayShadowEl .overlayContentEl {\n  position: absolute;\n  left: 50%;\n  top: 50%;\n  transform: translate(-50%, -50%);\n}\n.OverlaidView .overlayShadowEl.shadowed {\n  background: rgba(var(--shadow-color-rgb), 0.75);\n}\n.OverlaidView .overlayShadowEl.shadowed .overlayContentEl {\n  color: var(--inverted-shadow-color);\n}\n";
    ...
    class InformativeView extends OverlaidViewMixin(SuperClass) {
      ...
      async draw () {
        ...
        if (this._error) {
          ...
          this.informativeIconEl.attr('src', this.loading ? img : null)
...
var utils = /*#__PURE__*/Object.freeze({
  __proto__: null,
  OverlaidView: OverlaidView,
  OverlaidViewMixin: OverlaidViewMixin,
  InformativeView: InformativeView,
  InformativeViewMixin: InformativeViewMixin,
...
const { ButtonView, ButtonViewMixin } = uki.utils.createMixinAndDefault({
  ...
  classDefFunc: SuperClass => {
    class ButtonView extends RecolorableImageViewMixin(ThemeableMixin({
      SuperClass, defaultStyle: defaultStyle$1, className: 'ButtonView'
    })) {
      constructor (options) {
        super(options);
...
const { TooltipView, TooltipViewMixin } = uki.utils.createMixinAndDefault({
  ...
  classDefFunc: SuperClass => {
    class TooltipView extends ThemeableMixin({
      SuperClass, defaultStyle: defaultStyle$2, className: 'TooltipView'
    }) {
      constructor (options = {}) {
        super(options);
...
const { ModalView, ModalViewMixin } = uki.utils.createMixinAndDefault({
  ...
  classDefFunc: SuperClass => {
    class ModalView extends ThemeableMixin({
      SuperClass, defaultStyle: defaultStyle$3, className: 'ModalView'
    }) {
      constructor (options = {}) {
        super(options);
...
var components = /*#__PURE__*/Object.freeze({
  ...
  ButtonViewMixin: ButtonViewMixin,
  ModalView: ModalView,
...
const { GLRootView, GLRootViewMixin } = uki.utils.createMixinAndDefault({
  ...
  classDefFunc: SuperClass => {
    class GLRootView extends RecolorableImageViewMixin(ThemeableMixin({
      SuperClass, defaultStyle: defaultStyle$5, className: 'GLRootView'
    })) {
      constructor (options) {
        options.resources = options.resources || [];
...
var defaultStyle$6 = ".GLView.scrollArea {\n  position: absolute;\n  top: 0.5em;\n  left: 0.5em;\n  right: 0.5em;\n  bottom: 0.5em;\n  overflow: auto;\n}\n";
...
const { GLView, GLViewMixin } = uki.utils.createMixinAndDefault({
  ...
  classDefFunc: SuperClass => {
    class GLView extends uki.utils.IntrospectableMixin(ThemeableMixin({
      SuperClass, defaultStyle: defaultStyle$6, className: 'GLView'
    })) {
      constructor (options) {
        super(options);
...
var defaultStyle$7 = ".LineChartView path {\n  fill: none;\n  stroke-width: 1px;\n  stroke: var(--text-color-normal);\n}\n";
...
const { LineChartView, LineChartViewMixin } = uki.utils.createMixinAndDefault({
  ...
  classDefFunc: SuperClass => {
    class LineChartView extends SvgViewMixin(ThemeableMixin({
      SuperClass, defaultStyle: defaultStyle$7, className: 'LineChartView'
    })) {
      constructor (options) {
        super(options);
...
export { components, globalUI, goldenlayout, tables, utils, version$1 as version, vis };
